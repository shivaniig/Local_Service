...
const Dashboard = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      comment: "Fixed my electrical issues promptly. Great service at a reasonable price.",
      rating: 4,
    },
  ]
  const handleSearch = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="flex items-center text-black border border-white rounded-full px-4 py-2 bg-white bg-opacity-10 backdrop-blur-sm">
        <h1 className="mr-2 font-medium text-black">Current Location:</h1>
    ...
    <FaUser className="text-blue-600 text-lg" />
                ...
                {isMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10">
                    <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-blue-100">
                      Profile
                    </a>
                    <a href="#" className="block px-4 py-2 text-gray-800 hover:bg-blue-100">
                      My Bookings
  ...
  <div className="container mx-auto text-center">
    ...
    {selectedService && (
      <div
        className="mt-8 bg-white p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg"
      >
        <div
        ...
        <h3 className="mt-4 text-2xl font-semibold text-gray-800">{selectedService.name}</h3>
        <p className="text-gray-600">{selectedService.description}</p>
        <div className="mt-2 flex justify-between items-center">
          <p className="text-sm text-gray-500">
            Rating: {selectedService.rating} | Bookings: {selectedService.bookings}
          </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      {services.map((service, index) => (
        ...
        >
          ...
          <div className="p-6">
            {/* Service Icon */}
            <div className={`text-3xl mb-4 w-12 h-12 flex items-center justify-center rounded-full text-white ${service.color}`}>
              {service.icon}
            </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-semibold text-gray-800">Book {selectedService.name}</h3>
                <button className="text-gray-500 hover:text-gray-700" onClick={() => setShowBookingModal(false)}>
                  <svg
                    className="w-6 h-6"
                    fill="none"
                    stroke="currentColor"
              ...
              <form onSubmit={handleSubmitBooking}>
                <div className="mb-4">
                  <label className="block text-gray-700 text-sm font-medium mb-2">Service</label>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <label
                      className={`flex items-center p-3 border rounded-lg cursor-pointer ${paymentMethod === "cash" ? "border-blue-500 bg-blue-50" : "border-gray-300"}`}
                    >
                      <input
                        type="radio"
                        name="paymentMethod"
                      ...
                      />
                      <FaMoneyBillWave
                        className={`mr-2 ${paymentMethod === "cash" ? "text-blue-500" : "text-gray-500"}`}
                      />
                      <span className={paymentMethod === "cash" ? "text-blue-700" : "text-gray-700"}>
                        Cash on Delivery
                      </span>
                    </label>

                    <label
                      className={`flex items-center p-3 border rounded-lg cursor-pointer ${paymentMethod === "online" ? "border-blue-500 bg-blue-50" : "border-gray-300"}`}
                    >
                      <input
                        type="radio"
                        name="paymentMethod"
                      ...
                      />
                      <FaCreditCard
                        className={`mr-2 ${paymentMethod === "online" ? "text-blue-500" : "text-gray-500"}`}
                      />
                      <span className={paymentMethod === "online" ? "text-blue-700" : "text-gray-700"}>
                        Online Payment
                      </span>
                    </label>
                  </div>
      ...
      {showReviewModal && selectedService && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-xl font-semibold text-gray-800">Review {selectedService.name}</h3>
                <button className="text-gray-500 hover:text-gray-700" onClick={() => setShowReviewModal(false)}>
                  <svg
                    className="w-6 h-6"
                    fill="none"
                    stroke="currentColor"
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">Your trusted partner for all home service needs.</p>
            </div>
