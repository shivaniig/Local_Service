...
export default function AdminDashboard() {
  ...
  const recentBookings = [
    { id: 1, name: "Booking #001", date: "2025-04-18", status: "Completed" },
    { id: 2, name: "Booking #002", date: "2025-04-17", status: "Pending" },
    { id: 3, name: "Booking #003", date: "2025-04-15", status: "Completed" },
    { id: 4, name: "Booking #004", date: "2025-04-14", status: "Pending" },
  ]
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col justify-between sm:flex-row sm:items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900 md:text-3xl">Admin Dashboard</h1>
        <div className="mt-4 flex space-x-2 sm:mt-0">
          <button
            onClick={() => setViewMode("grid")}
      ...
      <div className="rounded-lg bg-white p-6 shadow-md">
        ...
        {recentBookings.length === 0 ? (
              ...
              <div key={booking.id} className="rounded-lg border border-gray-200 p-4">
                <div className="mb-3 flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h4 className="text-sm font-semibold text-gray-900">{booking.name}</h4>
          ...
          <ul>
            {recentBookings.map((booking) => (
              <li key={booking.id} className="py-3 px-4 border-b border-gray-200">
