                        ...
                        <div className="grid grid-cols-3 gap-2 sm:grid-cols-5 md:grid-cols-7">
                            {getAvailableDates().map((date, index) => (
                                <button
                                    ...
                                    className={`flex flex-col items-center rounded-lg border p-2 transition-colors ${selectedDate === date.toISOString().split("T")[0]
                        ...
                        <div className="grid grid-cols-3 gap-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6">
                            {timeSlots.map((time, index) => (
                                <button
                                    ...
                                    className={`rounded-lg border p-2 text-center transition-colors ${selectedTime === time
                                        ? "border-blue-500 bg-blue-50 text-blue-600"
                                        : "border-gray-200 hover:border-blue-200 hover:bg-blue-50"
                                        }`}
                                >
                ...
                <div className="rounded-lg bg-white p-6 shadow-md">
                    ...
                    <div className="mb-6 space-y-3">
                        <div
                            ...
                            className={`flex cursor-pointer items-center rounded-lg border p-4 transition-colors ${paymentMethod === "cash" ? "border-blue-500 bg-blue-50" : "border-gray-200"
                                }`}
                        >
                            <div className="mr-4">
                        ...
                        <div
                            ...
                            className={`flex cursor-pointer items-center rounded-lg border p-4 transition-colors ${paymentMethod === "online" ? "border-blue-500 bg-blue-50" : "border-gray-200"
                                }`}
                        >
                            <div className="mr-4">
